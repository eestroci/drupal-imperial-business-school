  ...
  window,
	{
		"nol_GLOBALS":{
			...
			"nol_osGroup":"",
			"nol_platform":"",
			"nol_clientid":"it-402816","nol_vcid":"c03","nol_clientCMSmap":{"nol_clientid":"clientid","nol_vcid":"subbrand","nol_vidtype":"type","nol_assetid":"assetid","nol_assetName":"(section)"},"nol_sfcode":"it",
			"nol_cidOffsetNull":"00000",
			"nol_emmsfcodelist":["eu","eu-cert","eu-uat","pl","pl-cert","cert","qat4","us","dcr","sdk","dcr-cert","au","it","dmk","sw","ire","twn","fr","th","th-cert"],
			...
			"nol_fbver":"1",
			"nol_appid":"P6A5FC03E-6095-497D-AC00-AC0CD7818AA7",
			...
			"nol_intrvlThrshldDTVR":"90",
			"nol_pauseEventTimeoutDTVR":"15",
			...
			"nol_tagMap":{
					"nol_product":["dpr","mtvr","vc", "id3", "ocr", "drm", "dprid3","dcrstatic", "dcrvideo","vrivideo","mtvrsubminute"],
...
"",
"",
"|!nol_ocrtag!|&c9=devid,|![nol_deviceId]!|&c8=devgrp,&c29=plid,|![nol_playerId]!|&c30=bldv,|![nol_bldv]!|&c7=osgrp,&c10=plt,&c11=agg,|!nol_aggregate!|&c12=apv,|![nol_appver]!|&c13=asid,P6A5FC03E-6095-497D-AC00-AC0CD7818AA7&c14=osver,NA&c26=dmap,3&c24=zip,99&uoo=|![nol_useroptout]!|&c68=bndlid,&c61=createtm,|![nol_createTime||nol_pingCreationTime]!|&c62=sendTime,|![nol_sendTime]!|&nodeTM=|![nol_nodetm]!|&logTM=|![nol_logtm]!|&c73=phtype,&c74=dvcnm,&sdd=",
"",
"",
"",
"",
